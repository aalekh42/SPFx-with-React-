...
export default class DataIntoBsTable extends React.Component<IDataIntoBsTableProps, {}> {
  public render(): React.ReactElement<IDataIntoBsTableProps> {
    ...
    return (
      <section className={`${styles.dataIntoBsTable} ${hasTeamsContext ? styles.teams : ''}`}>
